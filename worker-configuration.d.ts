/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bc6691229e5cc6f5101e71bd6e6eb7a9)
// Runtime types generated with workerd@1.20260312.1 2025-01-21 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Garden" | "MultiplayerComments";
	}
	interface Env {
		...
		R2_TOKEN_ID: string;
		R2_RO_ACCESS_KEY_ID: string;
		R2_RO_SECRET_ACCESS_KEY: string;
		R2_RO_TOKEN_ID: string;
		LAMBDA_API_KEY: string;
		SUTRO_API_KEY: string;
		GOOGLECLOUD_API_KEY: string;
		...
		PROTECTED_CONTENT_PASSWORD: string;
		LYD_2: string;
		NICKY: string;
		THERAPY: string;
		BENNETT: string;
		...
		RABIA: string;
		EMAIL_SENDER: string;
		EMAIL_EMITTER_SECRET: string;
		RESEND_API_KEY: string;
		MCP_OBJECT: DurableObjectNamespace<import("./worker/index").Garden>;
		MULTIPLAYER_COMMENTS: DurableObjectNamespace<import("./worker/index").MultiplayerComments>;
	}
}
